...
This page is a short chapter on anti skills and bad. In economics and finance, good anti skills and bad taste means that the researcher makes a choice that improves the argument rather than merely decorating it. The choice should make the project more important, more credible, easier to test, or easier to understand. If it does none of those things, it is probably style rather than taste.

Good anti skills and bad taste begins with pressure. A researcher should be able to say what would go wrong if this dimension were weak. A question without importance produces a forgettable paper. A measure without conceptual discipline produces false precision. A mechanism without a real test becomes storytelling. A contribution without audience discipline becomes self-description. The chapter asks you to notice that pressure before you polish the prose.

```mermaid
flowchart LR
    A["Research choice"] --> B["What does it clarify?"]
    B --> C["What objection does it answer?"]
    C --> D["What claim becomes safer?"]
    D --> E["What still cannot be claimed?"]
```
