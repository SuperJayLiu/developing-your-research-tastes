...
This page summarizes a working hypothesis about this journal's research taste: **methodological, theoretical, and econometric contributions with high conceptual precision**.
...
- formal clarity
- new method or model
- identification/estimation discipline
- generalizable insight

## What Usually Feels Too Weak

- applied result without conceptual innovation
- method not clearly useful
- informal mechanism
