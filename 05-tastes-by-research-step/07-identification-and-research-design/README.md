...
```mermaid
flowchart TB
    A["Decision at this step"] --> B["Main scholarly audience"]
    A --> C["Strongest skeptical objection"]
    B --> D["Revision that improves fit"]
    C --> D
    D --> E["Taste log update"]
```
