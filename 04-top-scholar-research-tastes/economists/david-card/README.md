...
This page extracts reusable research taste from David Card: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
## Skill: Find comparison groups in real-world labor markets

**Scholar source:** David Card  
...
```text
I am working on a research idea in economics. Apply the **Find comparison groups in real-world labor markets** skill, inspired by David Card.
...
This skill turns a repeated research move in David Card's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Find comparison groups in real-world labor markets
...
## Skill: Let transparent empirical design discipline controversial questions
...
```text
I am working on a research idea in economics. Apply the **Let transparent empirical design discipline controversial questions** skill, inspired by David Card.
...
```text
Project idea: [write your topic]
Skill applied: Let transparent empirical design discipline controversial questions
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
## Skill: Use natural experiments to challenge conventional wisdom
...
```text
I am working on a research idea in economics. Apply the **Use natural experiments to challenge conventional wisdom** skill, inspired by David Card.
...
```text
Project idea: [write your topic]
Skill applied: Use natural experiments to challenge conventional wisdom
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
