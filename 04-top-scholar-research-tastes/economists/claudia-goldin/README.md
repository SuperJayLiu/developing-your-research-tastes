...
This page extracts reusable research taste from Claudia Goldin: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
```text
I am working on a research idea in economics. Apply the **Combine narrative, measurement, and economics into one argument** skill, inspired by Claudia Goldin.
...
This skill turns a repeated research move in Claudia Goldin's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Combine narrative, measurement, and economics into one argument
...
```text
I am working on a research idea in economics. Apply the **Turn descriptive patterns into deep institutional questions** skill, inspired by Claudia Goldin.
...
```text
Project idea: [write your topic]
Skill applied: Turn descriptive patterns into deep institutional questions
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in economics. Apply the **Use history to explain long-run labor market change** skill, inspired by Claudia Goldin.
...
```text
Project idea: [write your topic]
Skill applied: Use history to explain long-run labor market change
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
