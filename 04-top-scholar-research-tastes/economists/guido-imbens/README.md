...
This page extracts reusable research taste from Guido Imbens: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
```text
I am working on a research idea in economics. Apply the **Clarify what an estimand means before estimating it** skill, inspired by Guido Imbens.
...
This skill turns a repeated research move in Guido Imbens's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Clarify what an estimand means before estimating it
...
```text
I am working on a research idea in economics. Apply the **Formalize causal inference without losing applied intuition** skill, inspired by Guido Imbens.
...
```text
Project idea: [write your topic]
Skill applied: Formalize causal inference without losing applied intuition
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in economics. Apply the **Separate design-based credibility from modeling assumptions** skill, inspired by Guido Imbens.
...
```text
Project idea: [write your topic]
Skill applied: Separate design-based credibility from modeling assumptions
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
