...
This page extracts reusable research taste from Raj Chetty: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
```text
I am working on a research idea in economics. Apply the **Make descriptive evidence causal through credible variation and validation** skill, inspired by Raj Chetty.
...
This skill turns a repeated research move in Raj Chetty's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Make descriptive evidence causal through credible variation and validation
...
```text
I am working on a research idea in economics. Apply the **Turn granular empirical facts into policy-relevant design** skill, inspired by Raj Chetty.
...
```text
Project idea: [write your topic]
Skill applied: Turn granular empirical facts into policy-relevant design
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in economics. Apply the **Use administrative data to map opportunity at scale** skill, inspired by Raj Chetty.
...
```text
Project idea: [write your topic]
Skill applied: Use administrative data to map opportunity at scale
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
