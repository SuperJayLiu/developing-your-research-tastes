...
This page extracts reusable research taste from Michael Kremer: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
```text
I am working on a research idea in economics. Apply the **Design experiments around practical policy bottlenecks** skill, inspired by Michael Kremer.
...
This skill turns a repeated research move in Michael Kremer's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Design experiments around practical policy bottlenecks
...
```text
I am working on a research idea in economics. Apply the **Turn development constraints into researchable mechanisms** skill, inspired by Michael Kremer.
...
```text
Project idea: [write your topic]
Skill applied: Turn development constraints into researchable mechanisms
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in economics. Apply the **Use randomized evaluation to test scalable interventions** skill, inspired by Michael Kremer.
...
```text
Project idea: [write your topic]
Skill applied: Use randomized evaluation to test scalable interventions
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
