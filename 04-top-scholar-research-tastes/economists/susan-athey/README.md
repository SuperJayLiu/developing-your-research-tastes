...
This page extracts reusable research taste from Susan Athey: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
```text
I am working on a research idea in economics. Apply the **Combine theory, computation, and causal inference** skill, inspired by Susan Athey.
...
This skill turns a repeated research move in Susan Athey's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Combine theory, computation, and causal inference
...
```text
I am working on a research idea in economics. Apply the **Translate platform and market design problems into empirical questions** skill, inspired by Susan Athey.
...
```text
Project idea: [write your topic]
Skill applied: Translate platform and market design problems into empirical questions
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in economics. Apply the **Use machine learning to improve causal and policy analysis** skill, inspired by Susan Athey.
...
```text
Project idea: [write your topic]
Skill applied: Use machine learning to improve causal and policy analysis
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
