...
This page extracts reusable research taste from Thomas Piketty: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
```text
I am working on a research idea in economics. Apply the **Build long-run data to reopen old questions** skill, inspired by Thomas Piketty.
...
This skill turns a repeated research move in Thomas Piketty's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Build long-run data to reopen old questions
...
```text
I am working on a research idea in economics. Apply the **Turn distributional history into macroeconomic evidence** skill, inspired by Thomas Piketty.
...
```text
Project idea: [write your topic]
Skill applied: Turn distributional history into macroeconomic evidence
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in economics. Apply the **Use public-facing data infrastructure as part of research contribution** skill, inspired by Thomas Piketty.
...
```text
Project idea: [write your topic]
Skill applied: Use public-facing data infrastructure as part of research contribution
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
