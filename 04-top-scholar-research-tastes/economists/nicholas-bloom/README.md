...
This page extracts reusable research taste from Nicholas Bloom: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
```text
I am working on a research idea in economics. Apply the **Convert organizational practices into empirical objects** skill, inspired by Nicholas Bloom.
...
This skill turns a repeated research move in Nicholas Bloom's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Convert organizational practices into empirical objects
...
```text
I am working on a research idea in economics. Apply the **Measure management as an economic variable** skill, inspired by Nicholas Bloom.
...
```text
Project idea: [write your topic]
Skill applied: Measure management as an economic variable
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in economics. Apply the **Use surveys and experiments to study firms from the inside** skill, inspired by Nicholas Bloom.
...
```text
Project idea: [write your topic]
Skill applied: Use surveys and experiments to study firms from the inside
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
