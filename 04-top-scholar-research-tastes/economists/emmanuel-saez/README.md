...
This page extracts reusable research taste from Emmanuel Saez: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
```text
I am working on a research idea in economics. Apply the **Connect empirical public finance to welfare analysis** skill, inspired by Emmanuel Saez.
...
This skill turns a repeated research move in Emmanuel Saez's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Connect empirical public finance to welfare analysis
...
```text
I am working on a research idea in economics. Apply the **Translate sufficient statistics into policy-relevant formulas** skill, inspired by Emmanuel Saez.
...
```text
Project idea: [write your topic]
Skill applied: Translate sufficient statistics into policy-relevant formulas
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in economics. Apply the **Use tax data to measure inequality and behavioral responses** skill, inspired by Emmanuel Saez.
...
```text
Project idea: [write your topic]
Skill applied: Use tax data to measure inequality and behavioral responses
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
