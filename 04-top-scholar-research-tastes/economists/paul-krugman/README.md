...
The research move is to build simple models that change how a field sees a problem in a way that changes the project's decision rule. Read the evidence anchors above and ask what the scholar makes precise: the question, the mechanism or design, the evidence standard, and the boundary of the claim. Your project version should name those pieces before it borrows the move.

Practice the skill in one page. First, write the situation in which you would use "Build simple models that change how a field sees a problem". Second, state the mechanism, comparison, measure, or benchmark in one sentence. Third, name the closest alternative explanation. Fourth, describe the evidence that would change a skeptical reader's mind. Fifth, write the narrowest honest contribution claim.
...
A useful self-review prompt is: "Apply the skill 'Build simple models that change how a field sees a problem' to my project. Identify the trigger, the research move, the evidence anchor, the closest alternative explanation, the feedback signal, the failure mode, and the transfer sentence."
...
The research move is to use increasing returns and geography to explain trade patterns in a way that changes the project's decision rule. Read the evidence anchors above and ask what the scholar makes precise: the question, the mechanism or design, the evidence standard, and the boundary of the claim. Your project version should name those pieces before it borrows the move.

Practice the skill in one page. First, write the situation in which you would use "Use increasing returns and geography to explain trade patterns". Second, state the mechanism, comparison, measure, or benchmark in one sentence. Third, name the closest alternative explanation. Fourth, describe the evidence that would change a skeptical reader's mind. Fifth, write the narrowest honest contribution claim.
...
A useful self-review prompt is: "Apply the skill 'Use increasing returns and geography to explain trade patterns' to my project. Identify the trigger, the research move, the evidence anchor, the closest alternative explanation, the feedback signal, the failure mode, and the transfer sentence."
...
The research move is to communicate technical ideas through sharp economic intuition in a way that changes the project's decision rule. Read the evidence anchors above and ask what the scholar makes precise: the question, the mechanism or design, the evidence standard, and the boundary of the claim. Your project version should name those pieces before it borrows the move.

Practice the skill in one page. First, write the situation in which you would use "Communicate technical ideas through sharp economic intuition". Second, state the mechanism, comparison, measure, or benchmark in one sentence. Third, name the closest alternative explanation. Fourth, describe the evidence that would change a skeptical reader's mind. Fifth, write the narrowest honest contribution claim.
...
A useful self-review prompt is: "Apply the skill 'Communicate technical ideas through sharp economic intuition' to my project. Identify the trigger, the research move, the evidence anchor, the closest alternative explanation, the feedback signal, the failure mode, and the transfer sentence."
