...
This page extracts reusable research taste from Matthew Gentzkow: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
**Scholar source:** Matthew Gentzkow  
...
```text
I am working on a research idea in economics. Apply the **Measure information, media, and persuasion from text and behavior** skill, inspired by Matthew Gentzkow.
...
This skill turns a repeated research move in Matthew Gentzkow's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Measure information, media, and persuasion from text and behavior
...
```text
I am working on a research idea in economics. Apply the **Turn digitized content into economic evidence** skill, inspired by Matthew Gentzkow.
...
```text
Project idea: [write your topic]
Skill applied: Turn digitized content into economic evidence
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in economics. Apply the **Use structural and reduced-form tools to study communication markets** skill, inspired by Matthew Gentzkow.
...
```text
Project idea: [write your topic]
Skill applied: Use structural and reduced-form tools to study communication markets
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
