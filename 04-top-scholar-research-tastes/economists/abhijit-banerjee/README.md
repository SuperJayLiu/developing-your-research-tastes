...
This page extracts reusable research taste from Abhijit Banerjee: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
**Scholar source:** Abhijit Banerjee  
...
```text
I am working on a research idea in economics. Apply the **Build theory from field-level institutional detail** skill, inspired by Abhijit Banerjee.
...
This skill turns a repeated research move in Abhijit Banerjee's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Build theory from field-level institutional detail
...
```text
I am working on a research idea in economics. Apply the **Treat policy variation as a way to learn mechanisms** skill, inspired by Abhijit Banerjee.
...
```text
Project idea: [write your topic]
Skill applied: Treat policy variation as a way to learn mechanisms
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in economics. Apply the **Use simple behavioral models to explain development puzzles** skill, inspired by Abhijit Banerjee.
...
```text
Project idea: [write your topic]
Skill applied: Use simple behavioral models to explain development puzzles
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
