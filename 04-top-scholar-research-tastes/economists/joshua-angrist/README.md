...
This page extracts reusable research taste from Joshua Angrist: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
```text
I am working on a research idea in economics. Apply the **Explain identification in plain language** skill, inspired by Joshua Angrist.
...
This skill turns a repeated research move in Joshua Angrist's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Explain identification in plain language
...
```text
I am working on a research idea in economics. Apply the **Turn messy policy variation into credible causal designs** skill, inspired by Joshua Angrist.
...
```text
Project idea: [write your topic]
Skill applied: Turn messy policy variation into credible causal designs
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in economics. Apply the **Use instrumental variables as a design, not a ritual** skill, inspired by Joshua Angrist.
...
```text
Project idea: [write your topic]
Skill applied: Use instrumental variables as a design, not a ritual
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
