...
This page extracts reusable research taste from Edward Glaeser: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
```text
I am working on a research idea in economics. Apply the **Connect institutions, geography, and human capital** skill, inspired by Edward Glaeser.
...
This skill turns a repeated research move in Edward Glaeser's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Connect institutions, geography, and human capital
...
```text
I am working on a research idea in economics. Apply the **Treat cities as laboratories for economic mechanisms** skill, inspired by Edward Glaeser.
...
```text
Project idea: [write your topic]
Skill applied: Treat cities as laboratories for economic mechanisms
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in economics. Apply the **Use simple theory to organize spatial facts** skill, inspired by Edward Glaeser.
...
```text
Project idea: [write your topic]
Skill applied: Use simple theory to organize spatial facts
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
