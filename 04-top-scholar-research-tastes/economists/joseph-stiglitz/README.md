...
This page extracts reusable research taste from Joseph Stiglitz: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
**Scholar source:** Joseph Stiglitz  
...
```text
I am working on a research idea in economics. Apply the **Connect micro frictions to macro and policy outcomes** skill, inspired by Joseph Stiglitz.
...
This skill turns a repeated research move in Joseph Stiglitz's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Connect micro frictions to macro and policy outcomes
...
```text
I am working on a research idea in economics. Apply the **Treat information imperfections as first-order economic forces** skill, inspired by Joseph Stiglitz.
...
```text
Project idea: [write your topic]
Skill applied: Treat information imperfections as first-order economic forces
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in economics. Apply the **Use theory to challenge benchmark market-efficiency claims** skill, inspired by Joseph Stiglitz.
...
```text
Project idea: [write your topic]
Skill applied: Use theory to challenge benchmark market-efficiency claims
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
