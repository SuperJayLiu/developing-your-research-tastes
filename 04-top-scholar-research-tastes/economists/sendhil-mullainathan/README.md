...
This page extracts reusable research taste from Sendhil Mullainathan: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
**Scholar source:** Sendhil Mullainathan  
...
```text
I am working on a research idea in economics. Apply the **Connect psychology, data, and economic decision-making** skill, inspired by Sendhil Mullainathan.
...
This skill turns a repeated research move in Sendhil Mullainathan's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Connect psychology, data, and economic decision-making
...
```text
I am working on a research idea in economics. Apply the **Turn behavioral anomalies into research programs** skill, inspired by Sendhil Mullainathan.
...
```text
Project idea: [write your topic]
Skill applied: Turn behavioral anomalies into research programs
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in economics. Apply the **Use prediction problems to reveal hidden structure** skill, inspired by Sendhil Mullainathan.
...
```text
Project idea: [write your topic]
Skill applied: Use prediction problems to reveal hidden structure
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
