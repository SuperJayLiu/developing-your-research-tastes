...
This page extracts reusable research taste from James Heckman: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
```text
I am working on a research idea in economics. Apply the **Link econometric structure to human capital mechanisms** skill, inspired by James Heckman.
...
This skill turns a repeated research move in James Heckman's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Link econometric structure to human capital mechanisms
...
```text
I am working on a research idea in economics. Apply the **Think about treatment effects as heterogeneous and policy-specific** skill, inspired by James Heckman.
...
```text
Project idea: [write your topic]
Skill applied: Think about treatment effects as heterogeneous and policy-specific
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in economics. Apply the **Treat selection as a central research object** skill, inspired by James Heckman.
...
```text
Project idea: [write your topic]
Skill applied: Treat selection as a central research object
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
