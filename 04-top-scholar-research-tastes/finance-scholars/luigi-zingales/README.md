...
This page extracts reusable research taste from Luigi Zingales: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
```text
I am working on a research idea in finance. Apply the **Connect corporate finance to institutions and politics** skill, inspired by Luigi Zingales.
...
This skill turns a repeated research move in Luigi Zingales's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Connect corporate finance to institutions and politics
...
```text
I am working on a research idea in finance. Apply the **Treat trust, governance, and culture as economic mechanisms** skill, inspired by Luigi Zingales.
...
```text
Project idea: [write your topic]
Skill applied: Treat trust, governance, and culture as economic mechanisms
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in finance. Apply the **Use cross-country variation to study financial development** skill, inspired by Luigi Zingales.
...
```text
Project idea: [write your topic]
Skill applied: Use cross-country variation to study financial development
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
