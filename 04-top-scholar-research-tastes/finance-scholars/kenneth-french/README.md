...
This page extracts reusable research taste from Kenneth French: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
```text
I am working on a research idea in finance. Apply the **Make data tools part of the scientific contribution** skill, inspired by Kenneth French.
...
This skill turns a repeated research move in Kenneth French's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Make data tools part of the scientific contribution
...
```text
I am working on a research idea in finance. Apply the **Turn factor construction into reusable research infrastructure** skill, inspired by Kenneth French.
...
```text
Project idea: [write your topic]
Skill applied: Turn factor construction into reusable research infrastructure
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in finance. Apply the **Use portfolio sorts to reveal systematic return patterns** skill, inspired by Kenneth French.
...
```text
Project idea: [write your topic]
Skill applied: Use portfolio sorts to reveal systematic return patterns
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
