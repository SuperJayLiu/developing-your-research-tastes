...
This page extracts reusable research taste from Ulrike Malmendier: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
**Scholar source:** Ulrike Malmendier  
...
```text
I am working on a research idea in finance. Apply the **Link psychology, memory, and financial choice** skill, inspired by Ulrike Malmendier.
...
This skill turns a repeated research move in Ulrike Malmendier's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Link psychology, memory, and financial choice
...
```text
I am working on a research idea in finance. Apply the **Measure behavioral biases in corporate and household decisions** skill, inspired by Ulrike Malmendier.
...
```text
Project idea: [write your topic]
Skill applied: Measure behavioral biases in corporate and household decisions
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in finance. Apply the **Turn life experience into an economic state variable** skill, inspired by Ulrike Malmendier.
...
```text
Project idea: [write your topic]
Skill applied: Turn life experience into an economic state variable
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
