...
The page is built from representative paper anchors and public scholarly reputation, then translated into portable skills. The anchors are not decorative. They are a check against fantasy: if a skill cannot be seen across the papers, it should be downgraded or removed. Large Sample Properties of Generalized Method of Moments Estimators Robustness Uncertainty Outside and Inside Economic Models

| Evidence Anchor | What To Check |
|---|---|
| Large Sample Properties of Generalized Method of Moments Estimators | Use this paper to check whether the skill appears in question choice, mechanism, evidence, or framing. |
| Robustness | Use this paper to check whether the skill appears in question choice, mechanism, evidence, or framing. |
| Uncertainty Outside and Inside Economic Models | Use this paper to check whether the skill appears in question choice, mechanism, evidence, or framing. |

## Reading The Taste

When reading Lars Peter Hansen, focus first on the opening move. Ask how the paper convinces the reader that the question matters. Then look for the engine of the paper: the model, design, data construction, comparison, historical fact, market friction, institutional detail, or mechanism that does the real work. Finally, study the boundary. The strongest papers usually know what they have not proved.

## Skill: Use moment restrictions to discipline economic models

This skill captures one recurring move in Lars Peter Hansen's research taste. The point is not to copy the scholar's topic or vocabulary. The point is to borrow a decision rule: when a project reaches a similar problem, this move tells the researcher what to clarify, what to test, and what not to overclaim.
...
A useful self-review prompt is: "Apply the skill 'Use moment restrictions to discipline economic models' to my project. Explain the core puzzle, the mechanism, the test, the strongest alternative explanation, the honest contribution claim, and the boundary of the claim."
...
## Skill: Treat uncertainty and robustness as research objects
...
A useful self-review prompt is: "Apply the skill 'Treat uncertainty and robustness as research objects' to my project. Explain the core puzzle, the mechanism, the test, the strongest alternative explanation, the honest contribution claim, and the boundary of the claim."
...
## Skill: Connect econometric methods to asset pricing and macro-finance

This skill captures one recurring move in Lars Peter Hansen's research taste. The point is not to copy the scholar's topic or vocabulary. The point is to borrow a decision rule: when a project reaches a similar problem, this move tells the researcher what to clarify, what to test, and what not to overclaim.

The portable judgment is to turn a substantive research instinct into a disciplined sequence of question, mechanism, test, and boundary. In practice, use the skill by writing one paragraph that states the puzzle, one paragraph that names the mechanism or design, and one paragraph that explains what evidence would change the reader's mind. If those three paragraphs cannot be written, the project probably does not yet have enough structure for the skill to help.

A useful self-review prompt is: "Apply the skill 'Connect econometric methods to asset pricing and macro-finance' to my project. Explain the core puzzle, the mechanism, the test, the strongest alternative explanation, the honest contribution claim, and the boundary of the claim."

The critical boundary is important. This becomes bad taste when the surface style is copied without the underlying discipline. A strong use of the skill should make the project more honest as well as more ambitious.

## How To Use This Page

Use this page by choosing one skill and applying it to a live project in prose. Write the project version of the puzzle, the mechanism or design, the evidence standard, and the boundary. If the exercise only produces a slogan, return to the evidence anchors and read again. The goal is to absorb Lars Peter Hansen's research judgment without becoming derivative.
