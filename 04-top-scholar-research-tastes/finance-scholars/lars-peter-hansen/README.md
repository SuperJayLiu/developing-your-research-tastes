...
This page extracts reusable research taste from Lars Peter Hansen: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
**Scholar source:** Lars Peter Hansen  
...
```text
I am working on a research idea in finance. Apply the **Connect econometric methods to asset pricing and macro-finance** skill, inspired by Lars Peter Hansen.
...
This skill turns a repeated research move in Lars Peter Hansen's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Connect econometric methods to asset pricing and macro-finance
...
```text
I am working on a research idea in finance. Apply the **Treat uncertainty and robustness as research objects** skill, inspired by Lars Peter Hansen.
...
```text
Project idea: [write your topic]
Skill applied: Treat uncertainty and robustness as research objects
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in finance. Apply the **Use moment restrictions to discipline economic models** skill, inspired by Lars Peter Hansen.
...
```text
Project idea: [write your topic]
Skill applied: Use moment restrictions to discipline economic models
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
