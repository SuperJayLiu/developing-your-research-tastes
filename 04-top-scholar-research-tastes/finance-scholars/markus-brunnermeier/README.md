...
This page extracts reusable research taste from Markus Brunnermeier: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
**Scholar source:** Markus Brunnermeier  
...
```text
I am working on a research idea in finance. Apply the **Connect micro frictions to systemic risk** skill, inspired by Markus Brunnermeier.
...
This skill turns a repeated research move in Markus Brunnermeier's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Connect micro frictions to systemic risk
...
```text
I am working on a research idea in finance. Apply the **Model financial fragility as endogenous amplification** skill, inspired by Markus Brunnermeier.
...
```text
Project idea: [write your topic]
Skill applied: Model financial fragility as endogenous amplification
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in finance. Apply the **Treat liquidity and leverage as dynamic state variables** skill, inspired by Markus Brunnermeier.
...
```text
Project idea: [write your topic]
Skill applied: Treat liquidity and leverage as dynamic state variables
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
