...
This page extracts reusable research taste from Jeremy Stein: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
```text
I am working on a research idea in finance. Apply the **Link corporate finance frictions to macro-financial outcomes** skill, inspired by Jeremy Stein.
...
This skill turns a repeated research move in Jeremy Stein's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Link corporate finance frictions to macro-financial outcomes
...
```text
I am working on a research idea in finance. Apply the **Treat investor sentiment as a force with real effects** skill, inspired by Jeremy Stein.
...
```text
Project idea: [write your topic]
Skill applied: Treat investor sentiment as a force with real effects
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in finance. Apply the **Use simple models to connect financial constraints and behavior** skill, inspired by Jeremy Stein.
...
```text
Project idea: [write your topic]
Skill applied: Use simple models to connect financial constraints and behavior
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
