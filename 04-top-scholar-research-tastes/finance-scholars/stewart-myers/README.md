...
This skill captures one recurring move in Stewart Myers's research taste. The point is not to copy the scholar's topic or vocabulary. The point is to borrow a decision rule: when a project reaches a similar problem, this move tells the researcher what to clarify, what to test, and what not to overclaim.
...
A useful self-review prompt is: "Apply the skill 'Explain corporate financing through information and investment frictions' to my project. Explain the core puzzle, the mechanism, the test, the strongest alternative explanation, the honest contribution claim, and the boundary of the claim."
...
A useful self-review prompt is: "Apply the skill 'Use pecking order logic to organize financing behavior' to my project. Explain the core puzzle, the mechanism, the test, the strongest alternative explanation, the honest contribution claim, and the boundary of the claim."
...
A useful self-review prompt is: "Apply the skill 'Connect real options to corporate investment decisions' to my project. Explain the core puzzle, the mechanism, the test, the strongest alternative explanation, the honest contribution claim, and the boundary of the claim."
