...
This page extracts reusable research taste from Eugene Fama: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
```text
I am working on a research idea in finance. Apply the **Convert market efficiency into testable implications** skill, inspired by Eugene Fama.
...
This skill turns a repeated research move in Eugene Fama's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Convert market efficiency into testable implications
...
```text
I am working on a research idea in finance. Apply the **Treat prices as disciplined summaries of information** skill, inspired by Eugene Fama.
...
```text
Project idea: [write your topic]
Skill applied: Treat prices as disciplined summaries of information
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in finance. Apply the **Use simple empirical regularities to organize an entire field** skill, inspired by Eugene Fama.
...
```text
Project idea: [write your topic]
Skill applied: Use simple empirical regularities to organize an entire field
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
