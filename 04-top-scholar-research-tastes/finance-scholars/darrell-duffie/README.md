...
This page extracts reusable research taste from Darrell Duffie: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
```text
I am working on a research idea in finance. Apply the **Translate market plumbing into asset pricing and policy implications** skill, inspired by Darrell Duffie.
...
This skill turns a repeated research move in Darrell Duffie's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Translate market plumbing into asset pricing and policy implications
...
```text
I am working on a research idea in finance. Apply the **Treat financial market design as a research object** skill, inspired by Darrell Duffie.
...
```text
Project idea: [write your topic]
Skill applied: Treat financial market design as a research object
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in finance. Apply the **Use institutional detail to model over-the-counter markets** skill, inspired by Darrell Duffie.
...
```text
Project idea: [write your topic]
Skill applied: Use institutional detail to model over-the-counter markets
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
