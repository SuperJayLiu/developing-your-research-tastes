...
This page extracts reusable research taste from Andrei Shleifer: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
## Skill: Build simple theories that explain broad empirical anomalies

**Scholar source:** Andrei Shleifer  
...
```text
I am working on a research idea in finance. Apply the **Build simple theories that explain broad empirical anomalies** skill, inspired by Andrei Shleifer.
...
This skill turns a repeated research move in Andrei Shleifer's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Build simple theories that explain broad empirical anomalies
...
## Skill: Turn behavioral limits into market-level implications
...
```text
I am working on a research idea in finance. Apply the **Turn behavioral limits into market-level implications** skill, inspired by Andrei Shleifer.
...
```text
Project idea: [write your topic]
Skill applied: Turn behavioral limits into market-level implications
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
## Skill: Use legal and institutional variation to study finance and growth

**Scholar source:** Andrei Shleifer  
**Skill family:** `empirical-design`  
**Status:** `draft-filled` — useful as a working skill card, but paper links and page-level citations still need verification before `reviewed`.
...
```text
I am working on a research idea in finance. Apply the **Use legal and institutional variation to study finance and growth** skill, inspired by Andrei Shleifer.
...
```text
Project idea: [write your topic]
Skill applied: Use legal and institutional variation to study finance and growth
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
