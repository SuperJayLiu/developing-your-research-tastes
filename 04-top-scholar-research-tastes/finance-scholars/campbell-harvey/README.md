...
This page extracts reusable research taste from Campbell Harvey: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
**Scholar source:** Campbell Harvey  
...
1. Start with the financial setting where the puzzle appears.
...
```text
I am working on a research idea in finance. Apply the **Build bridges between empirical finance and research credibility** skill, inspired by Campbell Harvey.
...
This skill turns a repeated research move in Campbell Harvey's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
For this scholar, the recurring introduction pattern is: the paper starts from a market, firm, intermediary, or price puzzle, then frames the paper around what the evidence can teach us about risk, beliefs, constraints, incentives, or financial institutions.
...
Skill applied: Build bridges between empirical finance and research credibility
...
```text
I am working on a research idea in finance. Apply the **Study expected returns through cross-sectional and global evidence** skill, inspired by Campbell Harvey.
...
```text
Project idea: [write your topic]
Skill applied: Study expected returns through cross-sectional and global evidence
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in finance. Apply the **Treat multiple testing and p-hacking as central finance problems** skill, inspired by Campbell Harvey.
...
```text
Project idea: [write your topic]
Skill applied: Treat multiple testing and p-hacking as central finance problems
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
