...
This page extracts reusable research taste from John Cochrane: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
```text
I am working on a research idea in finance. Apply the **Explain complex finance models through disciplined intuition** skill, inspired by John Cochrane.
...
This skill turns a repeated research move in John Cochrane's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Explain complex finance models through disciplined intuition
...
```text
I am working on a research idea in finance. Apply the **Translate discount rates into economic mechanisms** skill, inspired by John Cochrane.
...
```text
Project idea: [write your topic]
Skill applied: Translate discount rates into economic mechanisms
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in finance. Apply the **Use asset pricing theory as a unifying language** skill, inspired by John Cochrane.
...
```text
Project idea: [write your topic]
Skill applied: Use asset pricing theory as a unifying language
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
