...
The research move is to turn agency conflicts into corporate finance questions in a way that changes the project's decision rule. Read the evidence anchors above and ask what the scholar makes precise: the question, the mechanism or design, the evidence standard, and the boundary of the claim. Your project version should name those pieces before it borrows the move.

Practice the skill in one page. First, write the situation in which you would use "Turn agency conflicts into corporate finance questions". Second, state the mechanism, comparison, measure, or benchmark in one sentence. Third, name the closest alternative explanation. Fourth, describe the evidence that would change a skeptical reader's mind. Fifth, write the narrowest honest contribution claim.
...
A useful self-review prompt is: "Apply the skill 'Turn agency conflicts into corporate finance questions' to my project. Identify the trigger, the research move, the evidence anchor, the closest alternative explanation, the feedback signal, the failure mode, and the transfer sentence."
...
The research move is to use governance failures to explain firm behavior in a way that changes the project's decision rule. Read the evidence anchors above and ask what the scholar makes precise: the question, the mechanism or design, the evidence standard, and the boundary of the claim. Your project version should name those pieces before it borrows the move.

Practice the skill in one page. First, write the situation in which you would use "Use governance failures to explain firm behavior". Second, state the mechanism, comparison, measure, or benchmark in one sentence. Third, name the closest alternative explanation. Fourth, describe the evidence that would change a skeptical reader's mind. Fifth, write the narrowest honest contribution claim.
...
A useful self-review prompt is: "Apply the skill 'Use governance failures to explain firm behavior' to my project. Identify the trigger, the research move, the evidence anchor, the closest alternative explanation, the feedback signal, the failure mode, and the transfer sentence."
...
The research move is to convert organizational incentives into empirical predictions in a way that changes the project's decision rule. Read the evidence anchors above and ask what the scholar makes precise: the question, the mechanism or design, the evidence standard, and the boundary of the claim. Your project version should name those pieces before it borrows the move.

Practice the skill in one page. First, write the situation in which you would use "Convert organizational incentives into empirical predictions". Second, state the mechanism, comparison, measure, or benchmark in one sentence. Third, name the closest alternative explanation. Fourth, describe the evidence that would change a skeptical reader's mind. Fifth, write the narrowest honest contribution claim.
...
A useful self-review prompt is: "Apply the skill 'Convert organizational incentives into empirical predictions' to my project. Identify the trigger, the research move, the evidence anchor, the closest alternative explanation, the feedback signal, the failure mode, and the transfer sentence."
