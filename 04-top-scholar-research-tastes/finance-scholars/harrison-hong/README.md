...
This page extracts reusable research taste from Harrison Hong: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
```text
I am working on a research idea in finance. Apply the **Connect behavioral finance to limits of arbitrage** skill, inspired by Harrison Hong.
...
This skill turns a repeated research move in Harrison Hong's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Connect behavioral finance to limits of arbitrage
...
```text
I am working on a research idea in finance. Apply the **Study disagreement, constraints, and market mispricing** skill, inspired by Harrison Hong.
...
```text
Project idea: [write your topic]
Skill applied: Study disagreement, constraints, and market mispricing
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in finance. Apply the **Use social interaction and attention as finance mechanisms** skill, inspired by Harrison Hong.
...
```text
Project idea: [write your topic]
Skill applied: Use social interaction and attention as finance mechanisms
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
