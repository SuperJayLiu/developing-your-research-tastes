...
This page extracts reusable research taste from Hélène Rey: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
## Skill: Connect capital flows, exchange rates, and risk appetite

**Scholar source:** Hélène Rey  
...
```text
I am working on a research idea in finance. Apply the **Connect capital flows, exchange rates, and risk appetite** skill, inspired by Hélène Rey.
...
This skill turns a repeated research move in Hélène Rey's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Connect capital flows, exchange rates, and risk appetite
...
## Skill: Treat global financial cycles as constraints on national policy
...
```text
I am working on a research idea in finance. Apply the **Treat global financial cycles as constraints on national policy** skill, inspired by Hélène Rey.
...
```text
Project idea: [write your topic]
Skill applied: Treat global financial cycles as constraints on national policy
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
## Skill: Use international finance facts to challenge policy trilemmas
...
```text
I am working on a research idea in finance. Apply the **Use international finance facts to challenge policy trilemmas** skill, inspired by Hélène Rey.
...
```text
Project idea: [write your topic]
Skill applied: Use international finance facts to challenge policy trilemmas
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
