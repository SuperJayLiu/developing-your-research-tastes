...
This page extracts reusable research taste from Raghuram Rajan: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
```text
I am working on a research idea in finance. Apply the **Connect financial development to real economic outcomes** skill, inspired by Raghuram Rajan.
...
This skill turns a repeated research move in Raghuram Rajan's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Connect financial development to real economic outcomes
...
```text
I am working on a research idea in finance. Apply the **Treat banks and intermediaries as macro-relevant institutions** skill, inspired by Raghuram Rajan.
...
```text
Project idea: [write your topic]
Skill applied: Treat banks and intermediaries as macro-relevant institutions
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in finance. Apply the **Use institutional detail to understand crises and fragility** skill, inspired by Raghuram Rajan.
...
```text
Project idea: [write your topic]
Skill applied: Use institutional detail to understand crises and fragility
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
