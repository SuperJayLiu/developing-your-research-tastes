...
This page extracts reusable research taste from John Campbell: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
```text
I am working on a research idea in finance. Apply the **Connect household finance decisions to asset pricing and welfare** skill, inspired by John Campbell.
...
This skill turns a repeated research move in John Campbell's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Connect household finance decisions to asset pricing and welfare
...
```text
I am working on a research idea in finance. Apply the **Decompose asset prices into interpretable economic components** skill, inspired by John Campbell.
...
```text
Project idea: [write your topic]
Skill applied: Decompose asset prices into interpretable economic components
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in finance. Apply the **Use long-run return predictability as a window into risk and beliefs** skill, inspired by John Campbell.
...
```text
Project idea: [write your topic]
Skill applied: Use long-run return predictability as a window into risk and beliefs
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
