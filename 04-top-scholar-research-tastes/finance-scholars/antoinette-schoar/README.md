...
This page extracts reusable research taste from Antoinette Schoar: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
- Household Finance and Decision Frictions
...
**Scholar source:** Antoinette Schoar  
...
```text
I am working on a research idea in finance. Apply the **Connect managerial traits, contracts, and firm outcomes** skill, inspired by Antoinette Schoar.
...
This skill turns a repeated research move in Antoinette Schoar's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Connect managerial traits, contracts, and firm outcomes
...
```text
I am working on a research idea in finance. Apply the **Study household and entrepreneurial finance through decision frictions** skill, inspired by Antoinette Schoar.
...
```text
Project idea: [write your topic]
Skill applied: Study household and entrepreneurial finance through decision frictions
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in finance. Apply the **Use microdata to reveal financial behavior heterogeneity** skill, inspired by Antoinette Schoar.
...
```text
Project idea: [write your topic]
Skill applied: Use microdata to reveal financial behavior heterogeneity
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
