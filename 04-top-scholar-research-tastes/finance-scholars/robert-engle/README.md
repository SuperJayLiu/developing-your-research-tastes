...
This page extracts reusable research taste from Robert Engle: how the scholar selects questions, builds mechanisms or designs, tests claims, and frames the contribution in abstracts and introductions.
...
- SRISK and systemic risk materials
...
```text
I am working on a research idea in finance. Apply the **Build econometric tools from observed market behavior** skill, inspired by Robert Engle.
...
This skill turns a repeated research move in Robert Engle's work into a portable habit. The point is **not** to copy the scholar's topic. The point is to copy the judgment: how the paper moves from a puzzle to a mechanism, from a mechanism to a test, and from a test to a disciplined contribution claim.
...
Skill applied: Build econometric tools from observed market behavior
...
```text
I am working on a research idea in finance. Apply the **Model volatility as a dynamic economic object** skill, inspired by Robert Engle.
...
```text
Project idea: [write your topic]
Skill applied: Model volatility as a dynamic economic object
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
...
```text
I am working on a research idea in finance. Apply the **Turn risk measurement into research infrastructure** skill, inspired by Robert Engle.
...
```text
Project idea: [write your topic]
Skill applied: Turn risk measurement into research infrastructure
Puzzle: [what is surprising or unresolved?]
Mechanism: [X affects Y because Z]
Main test: [what evidence would support the mechanism?]
Alternative explanation: [what else could explain the same fact?]
